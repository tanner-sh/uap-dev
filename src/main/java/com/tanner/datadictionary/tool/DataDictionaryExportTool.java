...
public class DataDictionaryExportTool {
    ...
    public void export(String exportPath, List<TableInfo> selectedTables) throws Exception {
        List<AggTable> aggTableList = buildAggTables(selectedTables);
        String filePath = Path.of(exportPath, "datadictionary.pdf").toString();
        buildPdf(aggTableList, filePath);
    ...
    private void buildPdf(List<AggTable> aggTableList, String filePath) throws Exception {
